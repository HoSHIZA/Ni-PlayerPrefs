...
namespace NiGames.PlayerPrefs
{
    public static partial class NiPrefs
    {
        ...
        /// </summary>
        [MethodImpl(256)]
        public static void Set(string key, int value) => default(IntPlayerPrefsProvider).Set(key, value);
        ...
        /// </summary>
        [MethodImpl(256)]
        public static void Set(string key, float value) => default(FloatPlayerPrefsProvider).Set(key, value);
        ...
        /// </summary>
        [MethodImpl(256)]
        public static void Set(string key, bool value) => default(BoolPlayerPrefsProvider).Set(key, value);
    }
