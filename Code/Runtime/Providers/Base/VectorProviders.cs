...
namespace NiGames.PlayerPrefs
{
    public static partial class NiPrefs
    {
        ...
        /// </summary>
        [MethodImpl(256)]
        public static void Set(string key, Vector2 value) => default(Vector2PlayerPrefsProvider).Get(key, value);
        ...
        /// </summary>
        [MethodImpl(256)]
        public static void Set(string key, Vector2Int value) => default(Vector2IntPlayerPrefsProvider).Get(key, value);
        ...
        /// </summary>
        [MethodImpl(256)]
        public static void Set(string key, Vector3 value) => default(Vector3PlayerPrefsProvider).Get(key, value);
        ...
        /// </summary>
        [MethodImpl(256)]
        public static void Set(string key, Vector3Int value) => default(Vector3IntPlayerPrefsProvider).Get(key, value);
        ...
        /// </summary>
        [MethodImpl(256)]
        public static void Set(string key, Vector4 value) => default(Vector4PlayerPrefsProvider).Get(key, value);
    }
}
